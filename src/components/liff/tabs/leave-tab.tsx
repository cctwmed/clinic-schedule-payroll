    ...
    <div className="px-4 pt-4">
      ...
      {needsBind ? (
        ...
        <div className="space-y-4">
          ...
          <section className="rounded-2xl border border-emerald-100 bg-emerald-50/50 p-4 text-xs text-emerald-950">
            <p className="font-semibold text-emerald-900">特休假（勞基法第 38 條）</p>
            <ul className="mt-2 space-y-1 text-emerald-800">
              <li>六個月以上一年未滿：3 日</li>
              <li>一年以上二年未滿：7 日</li>
              <li>二年以上三年未滿：10 日</li>
              <li>三年以上五年未滿：每年 14 日</li>
              <li>五年以上十年未滿：每年 15 日</li>
              <li>十年以上：每年加給 1 日，加至 30 日為止</li>
            </ul>
            <p className="mt-2 text-[11px] text-emerald-700">
              系統依到職日週年制自動計算您目前週期額度（上方剩餘天數）。
            </p>
          </section>
