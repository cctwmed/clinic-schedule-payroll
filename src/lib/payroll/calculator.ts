...
export function calculateEmployeePayroll(
  ...
  const item: PayrollLineItem = {
    ...
    breakdown: {
      ...
      sickLeaveHours: leavePay.sickLeaveHours,
      sickLeaveDeduction: leavePay.sickLeaveDeduction,
      maternityLeaveHours: leavePay.maternityLeaveHours,
      maternityLeaveDeduction: leavePay.maternityLeaveDeduction,
      pregnancyRestHours: leavePay.pregnancyRestHours,
      pregnancyRestDeduction: leavePay.pregnancyRestDeduction,
      leaveDeductionTotal: leavePay.leaveDeductionTotal,
